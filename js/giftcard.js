...
let nombre = document.querySelector(".destino");
let nombreDestinatario = document.querySelector("#nombre-destinatario");

nombre.addEventListener("keyup",()=>{
    nombreDestinatario.innerHTML = nombre.value;
});
...
colores.forEach((i)=>{
    i.addEventListener("click",()=>{
        nombreDestinatario.classList.remove("dest-verde","dest-naranja","dest-rojo","dest-azul","dest-amarillo");
        nombreDestinatario.classList.add(`dest-${i.value}`);
    });
});
...
tamanios.forEach((i)=>{
    i.addEventListener("click",()=>{
        nombreDestinatario.style.fontSize = i.value;
    });
});

//monto
let monto = document.querySelector("#monto");
let vistaMonto = document.querySelector(".vista-monto");

monto.addEventListener("change",(e)=>{
    vistaMonto.innerHTML =  "$"+ e.target.value + ".-";
});
...
ubicaciones.forEach((i)=>{
    i.addEventListener("click",()=>{
        switch(i.value){
        case "1":
            vistaMonto.classList.remove("abajo-derecha","arriba-izquierda");
            vistaMonto.classList.add("abajo-derecha");
            break;
        case "2":
            vistaMonto.classList.remove("abajo-derecha","arriba-izquierda");
            vistaMonto.classList.add("arriba-izquierda");
            break;
        case "3":
            vistaMonto.classList.remove("abajo-derecha","arriba-izquierda");
            break;
...
fondos.forEach((i)=>{
    i.addEventListener("click",()=>{
        resultado.classList.remove("prev1","prev2","prev3","prev4","prev5");
        resultado.classList.add(`prev${i.value}`);
    });
});
...
let resultado1 = document.querySelector(".resultados");
